      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        ...
        <div className="flex flex-col gap-1">
          ...
          <input
            ...
            min="0"
            step="0.01"
            className="w-full rounded-lg border border-neutral-200 dark:border-neutral-200 bg-neutral-100/60 dark:bg-neutral-100/60 px-3 py-2 text-sm text-neutral-900 dark:text-neutral-900 placeholder:text-neutral-700 dark:placeholder:text-neutral-700 focus:border-blue-500 focus:outline-none"
          />
        </div>
