    ...
    <div className="min-h-screen bg-neutral-50 dark:bg-neutral-900 text-neutral-900 dark:text-neutral-100 rounded-b-3xl">
        ...
        <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="flex items-center gap-3 mb-4">
            ...
            <h1 className="text-4xl sm:text-5xl font-bold tracking-tight text-neutral-900 dark:text-neutral-200">
              {t("home.settingsPage.title")}
            </h1>
          </div>
          <p className="text-lg text-neutral-600 dark:text-neutral-400 max-w-2xl">
            {t("home.settingsPage.description")}
          </p>
        </div>
      </div>
      ...
      <main className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 -mt-8 relative z-10 pb-24">
        <div className="space-y-6">
          <PreferenceCard
            icon={Bell}
            title={t("home.settingsPage.communication.title")}
            description={t("home.settingsPage.communication.description")}
          >
            <ToggleRow label={t("home.settingsPage.communication.emailAlerts")} defaultChecked />
            <ToggleRow label={t("home.settingsPage.communication.weeklyDigest")} />
            <ToggleRow label={t("home.settingsPage.communication.smsNotifications")} />
          </PreferenceCard>

          <PreferenceCard
            icon={Shield}
            title={t("home.settingsPage.privacy.title")}
            description={t("home.settingsPage.privacy.description")}
          >
            <ToggleRow label={t("home.settingsPage.privacy.displayProfile")} defaultChecked />
            <ToggleRow label={t("home.settingsPage.privacy.allowMessages")} defaultChecked />
            <ToggleRow label={t("home.settingsPage.privacy.shareSignals")} />
          </PreferenceCard>
        </div>
        ...
        <div className="mt-8 rounded-2xl border border-primary-200 dark:border-primary-900/50 bg-gradient-to-br from-primary-50 to-transparent dark:from-primary-900/30 dark:to-transparent p-6 sm:p-8 backdrop-blur-sm">
          <h2 className="text-lg font-semibold text-neutral-900 dark:text-neutral-100 flex items-center gap-2">
            ...
            {t("home.settingsPage.upgrade.title")}
          </h2>
          <p className="mt-3 text-neutral-600 dark:text-neutral-400">
            {t("home.settingsPage.upgrade.description")}
          </p>
          <a
            href="/plans"
          ...
          >
            {t("home.settingsPage.upgrade.viewPlans")}
          </a>
        </div>
      </main>
    </div>
