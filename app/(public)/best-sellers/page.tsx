      ...
      <main className="pb-24">
        <section className="mx-auto flex w-full max-w-5xl flex-col items-center gap-4 px-6 py-12 text-center">
          ...
          <p className="max-w-3xl text-md text-slate-400">
            Explore what’s moving fast across MarketHub. Sign in to unlock quantities, pricing ladders, and buyer lists tailored to your business.
          </p>
        </section>
        ...
        <section className="mx-auto w-full max-w-7xl px-6">
          <div className="flex flex-col gap-6">
            {bestSellerProducts.map((product) => (
              <article
                key={product.id}
                className="rounded-3xl border border-slate-800 bg-slate-900/60 p-6 shadow-lg shadow-purple-950/20 transition hover:-translate-y-1 hover:border-purple-500/60 hover:shadow-purple-500/20 md:p-8"
              >
                <div className="flex flex-col gap-6 md:flex-row md:items-start md:justify-between">
                  ...
                  <div className="w-full max-w-sm rounded-2xl border border-slate-800 bg-slate-900/60 p-5">
                    ...
                    <Link
                      ...
                      className="mt-5 inline-flex items-center gap-2 text-xs font-semibold uppercase tracking-wide text-blue-400 hover:text-blue-300"
                    >
