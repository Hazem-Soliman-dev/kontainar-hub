...
function SearchFallback() {
  return (
    <div className="min-h-screen bg-neutral-900 text-slate-100 dark:bg-neutral-900 dark:text-neutral-100">
      <div className="flex items-center justify-center py-16">
        <div className="text-center">
          ...
          <p className="text-slate-400 dark:text-neutral-400">Loading search results...</p>
        </div>
      </div>
    </div>
  );
